...
$quiz_stmt = $conn->prepare("SELECT q.quiz_id, q.title, q.status, q.created_at, q.class_id,
                                     c.class_name, c.section, u.first_name, u.last_name,
...
<div class="dashboard-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="content">
            <a href="quizzes.php" class="btn btn-light" style="margin-bottom: 15px;"><i class="fas fa-arrow-left"></i> Back to Quizzes</a>
                ...
                <div class="card-body">
                    <div class="quiz-details">
                        ...
                        <div class="details-grid">
                            ...
                            <div><strong>Created By:</strong> <?php echo htmlspecialchars(($quiz['first_name'] ?? '') . ' ' . ($quiz['last_name'] ?? '')); ?></div>
