            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div style="display: flex; gap: 10px; margin-bottom: 20px; border-bottom: 2px solid var(--border-color);">
                        <button class="tab-button active" onclick="switchTab('inbox')" id="inboxTab" style="padding: 12px 24px; border: none; background: none; cursor: pointer; font-weight: 600; border-bottom: 3px solid #F59E0B; color: #F59E0B;">
    ...
    <div class="modal-content">
        ...
        <form method="POST">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="send_message" class="btn btn-warning">
...
function switchTab(tab) {
    ...
    if (tab === 'inbox') {
        ...
        document.getElementById('inboxTab').style.borderBottom = '3px solid #F59E0B';
        document.getElementById('inboxTab').style.color = '#F59E0B';
    } else {
        document.getElementById('sentContent').style.display = 'block';
        document.getElementById('sentTab').classList.add('active');
        document.getElementById('sentTab').style.borderBottom = '3px solid #F59E0B';
        document.getElementById('sentTab').style.color = '#F59E0B';
    }
}
