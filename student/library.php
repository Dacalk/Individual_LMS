...
// Issued books
$issued_query = $conn->prepare("SELECT lt.*, lb.title, lb.author, lb.isbn 
...
$issued_query->bind_param("i", $_SESSION['user_id']);
$issued_query->execute();
$issued_books = $issued_query->get_result();

// History
$history_query = $conn->prepare("SELECT lt.*, lb.title, lb.author, lb.isbn 
                                 FROM library_transactions lt
                                 JOIN library_books lb ON lt.book_id = lb.book_id
                                 WHERE lt.user_id = ?
                                 ORDER BY lt.created_at DESC");
$history_query->bind_param("i", $_SESSION['user_id']);
    ...
    <div class="main-content">
        ...
        <div class="content">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="nav-tabs">
                        <a href="?tab=issued" class="nav-tab <?php echo $active_tab === 'issued' ? 'active' : ''; ?>">
                            <span class="tab-icon"><i class="fas fa-book-open"></i></span>
                            <span class="tab-label">My Issued Books</span>
                        </a>
                        <a href="?tab=browse" class="nav-tab <?php echo $active_tab === 'browse' ? 'active' : ''; ?>">
                            <span class="tab-icon"><i class="fas fa-book"></i></span>
                            <span class="tab-label">Browse Library</span>
                        </a>
                        <a href="?tab=history" class="nav-tab <?php echo $active_tab === 'history' ? 'active' : ''; ?>">
