                    ...
                    <form method="POST">
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" value="<?php echo htmlspecialchars($student['admission_number']); ?>" disabled>
                            </div>
                            
                            <div class="form-group">
                                <label class="form-label">Class</label>
                                <input type="text" class="form-control" value="<?php echo $student['class_name'] ? htmlspecialchars($student['class_name'] . ' - ' . $student['section']) : 'Not Assigned'; ?>" disabled>
                            </div>
                            <?php endif; ?>
